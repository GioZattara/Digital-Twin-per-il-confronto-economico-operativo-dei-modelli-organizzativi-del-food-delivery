...
- Modello Factory: i rider sono dipendenti subordinati, retribuiti su base oraria con turni fissi pianificati e l'assegnazione degli ordini avviene tramite l'algoritmo ungherese
  che risolve un problema di ottimizzazione a costo minimo globale.
